...
def red_chisq(obs, calc, err, free_params):
    #calculates a reduced chi square (goodness of fit)
...
def optical_vel_to_ang(vels, Vsys, restwl):
    #converts velocity to wavelength
...
def CreateCube(filename, SlabLower, SlabUpper, ContLower1, ContUpper1,
	...
	# makes new subcube centered around data we want to focus on
	"""" 
...
def compute_rms(spec_axis, spectrum, ContLower, ContUpper):
	# taking continum and seeing how uncertain we can be about the noise
	"""
