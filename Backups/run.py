...
Author: Serena A. Cronin, edited by Tanya Bait
...
# import functions
from routine import CreateCube, InputParams, optical_vel_to_ang, FitRoutine
import time
...
savepath = '/Users/tanyabait/Documents/NGC253/FITS_files/central_region/'
save_fits_num = 1
...
# file names
filename = 'ADP.2019-08-24T09_53_08.548.fits'
vel_model = 'disk_smoothfixedvel_ngc253_allcube.fits'
...
Voutfl_red = 50  # needed for three systems of lines only
...
if fit2 == True:
  ...
  #  amps2 = [100, 100, 300, 300, 250, 250, 150, 150, 100, 100]
    amps2 = [100, 100, 300, 300, 300, 300, 150, 150, 150, 150]
